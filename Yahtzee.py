...
def redrawAll():
    ...
    sumPlayer1 = TextAsset(sum(data['scoreCard'][:][0]+data['scoreCard'][:][1]+data['scoreCard'][:][2]+data['scoreCard'][:][3]+data['scoreCard'][:][4]+data['scoreCard'][:][5]+data['scoreCard'][:][6]+data['scoreCard'][:][7]+data['scoreCard'][:][8]+data['scoreCard'][:][9]+data['scoreCard'][:][10]+data['scoreCard'][:][11]+data['scoreCard'][:][12]) ,fill=black, style='8pt Times')
    ...
    sumPlayer2 = TextAsset(sum(data['scoreCard2'][:][0]+data['scoreCard2'][:][1]+data['scoreCard2'][:][2]+data['scoreCard2'][:][3]+data['scoreCard2'][:][4]+data['scoreCard2'][:][5]+data['scoreCard2'][:][6]+data['scoreCard2'][:][7]+data['scoreCard2'][:][8]+data['scoreCard2'][:][9]+data['scoreCard2'][:][10]+data['scoreCard2'][:][11]+data['scoreCard2'][:][12]) ,fill=black, style='8pt Times')
